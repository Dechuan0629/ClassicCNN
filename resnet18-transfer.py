...
def main():
    ...
    cifar_train = DataLoader(train_dataset, shuffle=True, batch_size=batch_size,num_workers=4)
    cifar_test = DataLoader(test_dataset, shuffle=True, batch_size=batch_size,num_workers=4)
